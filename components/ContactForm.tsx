...
export const ContactForm = () => {
  ...
  return (
    <div className="flex justify-center bg-black w-full">
        <form onSubmit={handleSubmit} className="w-2/6 p-6 bg-black">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded bg-neutral-500 text-neutral-700 focus:ring focus:ring-white"
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border rounded bg-neutral-500 focus:ring focus:ring-white"

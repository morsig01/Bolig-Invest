...
const Hero = () => {
  return (
    ...
    <div className="bg-hero-pattern bg-cover bg-center">
      ...
      <div className="bg-gradient-to-b from-transparent to-black -mt-48 pt-36 pb-36 rounded-t-lg">
        <div className="flex justify-center items-center space-x-64">
          ...
          <div>
            ...
            <div className="text-white text-4xl font-bold my-7 flex justify-center">
              Investments made
            </div>
          </div>
          {/* circle 2 */}
